        ...
        <div>
            ...
            <form id="burger-form" @submit="createBurger">
                ...
                <div class="input-container">
                    ...
                    <select name="pão" id="pao" v-model="pao">
                ...
                <div id="opcionais-container" class="input-container">
                    <label id="opcionais-title" for="opcionias">Selicione os opcionais:</label>
                    <div class="checkbox-container" v-for="opcional in opcionaisdata" :key="opcional.id">
                        <input type="checkbox" name="opcionias" id="opcionias" v-model="opcionais" :value="opcional.tipo">
